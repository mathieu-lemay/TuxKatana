...
from tuxkatana.lib import Controller

from tuxkatana.widgets import Switcher, Settings, ConnectWait

import logging
from tuxkatana.lib.log_setup import setup_logger
from tuxkatana.resources import get_resource_file_path
log = setup_logger()
...
class TuxKatana(Gtk.Application):
    ...
    def do_activate(self):
        config = {}
        with open(get_resource_file_path("config.yaml"), "r") as f:
            config = yaml.load(f)
