...
import logging
from tuxkatana.lib.log_setup import LOGGER_NAME
log = logging.getLogger(LOGGER_NAME)

from tuxkatana.lib.effect import Effect
from tuxkatana.lib.set_mapping import add_properties

@add_properties()
class Harmonist(Effect, Gtk.Box):
    ha_harmony      = GObject.Property(type=str)
    ha_pred_lvl     = GObject.Property(type=float, default=0.0)
